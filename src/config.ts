...
const railwayPublicDomain = publicHttpsUrl(process.env.RAILWAY_PUBLIC_DOMAIN || "");
const configuredMiniAppUrl = publicHttpsUrl(process.env.MINI_APP_URL || "");
const productionMiniAppUrl = "https://metspod-d.up.railway.app";
const miniAppUrl = railwayPublicDomain || (process.env.RAILWAY_ENVIRONMENT ? productionMiniAppUrl : configuredMiniAppUrl);
