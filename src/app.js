(() => {
  ...
  function homeView() {
    ...
    return `<section class="hero-open"><div class="hero-scene" aria-hidden="true"></div><div class="hero-reach hero-reach-left" aria-hidden="true"><img class="hero-hand" src="/miniapp/assets/hero-hand-left.png" alt="" /><img class="hero-chip" src="/miniapp/assets/hero-chip-gift.png" alt="" /></div><div class="hero-reach hero-reach-right" aria-hidden="true"><img class="hero-hand" src="/miniapp/assets/hero-hand-right.png" alt="" /><img class="hero-chip" src="/miniapp/assets/hero-chip-ton.png" alt="" /></div><div class="hero-copy"><p class="hero-eyebrow wash">TON · SMART CONTRACT ESCROW</p><h1 class="wash">Безопасные<br>сделки в TON</h1><p class="wash">Деньги хранятся в отдельном смарт-контракте сделки и выпускаются только по её правилам.</p><div class="hero-actions"><button class="btn btn-primary" data-route="create">Создать сделку</button><button class="btn btn-secondary" data-route="deals">Мои сделки</button></div></div></section>
