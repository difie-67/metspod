...
export function storeDealInfo(src: DealInfo) {
    return (builder: Builder) => {
        ...
        b_1.storeBit(src.feeFromSeller);
...
export function loadDealInfo(slice: Slice) {
    ...
    const _feeFromSeller = sc_1.loadBit();
    const _networkFee = sc_1.loadCoins();
    const _state = sc_1.loadUintBig(8);
    return { $$type: 'DealInfo' as const, dealId: _dealId, buyer: _buyer, seller: _seller, arbiter: _arbiter, platform: _platform, amount: _amount, feeBps: _feeBps, feeFromSeller: _feeFromSeller, networkFee: _networkFee, state: _state };
}
...
export function loadTupleDealInfo(source: TupleReader) {
    ...
    const _feeFromSeller = source.readBoolean();
...
export function storeTupleDealInfo(source: DealInfo) {
    ...
    builder.writeBoolean(source.feeFromSeller);
...
export function loadEscrow$Data(slice: Slice) {
    ...
    const _networkFee = sc_1.loadCoins();
    const _state = sc_1.loadUintBig(8);
    return { $$type: 'Escrow$Data' as const, dealId: _dealId, buyer: _buyer, seller: _seller, arbiter: _arbiter, platform: _platform, amount: _amount, feeBps: _feeBps, feeFromSeller: _feeFromSeller, networkFee: _networkFee, state: _state };
}
...
function initEscrow_init_args(src: Escrow_init_args) {
    return (builder: Builder) => {
        ...
        b_2.storeBit(src.feeFromSeller);
...
async function Escrow_init(dealId: bigint, buyer: Address, seller: Address, arbiter: Address, platform: Address, amount: bigint, feeBps: bigint, feeFromSeller: boolean, networkFee: bigint) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initEscrow_init_args({ $$type: 'Escrow_init_args', dealId, buyer, seller, arbiter, platform, amount, feeBps, feeFromSeller, networkFee })(builder);
...
export class Escrow implements Contract {
    ...
    static async init(dealId: bigint, buyer: Address, seller: Address, arbiter: Address, platform: Address, amount: bigint, feeBps: bigint, feeFromSeller: boolean, networkFee: bigint) {
        return await Escrow_init(dealId, buyer, seller, arbiter, platform, amount, feeBps, feeFromSeller, networkFee);
    }
    
    static async fromInit(dealId: bigint, buyer: Address, seller: Address, arbiter: Address, platform: Address, amount: bigint, feeBps: bigint, feeFromSeller: boolean, networkFee: bigint) {
        const __gen_init = await Escrow_init(dealId, buyer, seller, arbiter, platform, amount, feeBps, feeFromSeller, networkFee);
